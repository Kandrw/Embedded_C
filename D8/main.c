    ...
    while(run_main_while){
        switch(panel){
                        ...
                        switch(set_but_conp){
                            ...
                            case 1:
                                ...
                                if(descriptor > -1){
                                    ...
                                    ptr_row = head;
                                    ptr_col = head->head_symbol;
                                    posx_cur_edit = 0; posy_cur_edit = 0;
                                }
                                else{
                                    //move(31, 5);
                                    wmove(control_panel, 3, 1);
            ...
            case EDIT_PANEL:
                ...
                //move(30, 1);
                //printw("posx = %d, posy = %d, col = %d, row = %d\n",posx_cur_edit, posy_cur_edit, col, row);
                //printw("editp: key = %d\n", key);
                Print_subpanel(edit_panel, head);
                //printw("pos: x = %d  y = %d\n", posx_cur_edit, posy_cur_edit);
                break;
            default:
                panel = 0;
                break;
